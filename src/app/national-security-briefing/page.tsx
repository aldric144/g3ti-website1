      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-[#12F6C8]/10">
            <div className="flex items-center justify-between">
              <Link href="/contractor-readiness.html" className="text-gray-400 hover:text-[#12F6C8] transition-colors">
                ← Contractor Readiness
              </Link>
              <Link href="/threat-architecture-addendum.html" className="text-[#12F6C8] hover:underline">
