    ...
    <div className="min-h-screen bg-[#050505]">
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0D0D0F] to-[#050505]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">ScamFirewall360™</h1>
          <p className="text-xl text-gray-400">Comprehensive Scam Prevention &amp; Fraud Detection Ecosystem</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#0D0D0F] border border-gray-800 rounded-xl p-8 mb-8">
            ...
            <p className="text-gray-400 mb-4">ScamFirewall360™ provides 360-degree protection against scams, fraud, and social engineering attacks targeting individuals and organizations.</p>
          ...
          <div className="bg-[#0D0D0F] border border-gray-800 rounded-xl p-8 mb-8">
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li>• Voice clone identification</li>
              <li>• Phishing prevention</li>
              <li>• Elder fraud protection</li>
            </ul>
          </div>
