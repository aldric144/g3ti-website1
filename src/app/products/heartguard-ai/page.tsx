    ...
    <div className="min-h-screen bg-[#050505]">
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0D0D0F] to-[#050505]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">HeartGuard AI™</h1>
          <p className="text-xl text-gray-400">Domestic Violence Prediction &amp; Victim Protection Intelligence</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#0D0D0F] border border-gray-800 rounded-xl p-8 mb-8">
            ...
            <p className="text-gray-400 mb-4">HeartGuard AI™ uses behavioral intelligence to predict domestic violence escalation and protect victims before harm occurs.</p>
          ...
          <div className="bg-[#0D0D0F] border border-gray-800 rounded-xl p-8 mb-8">
            ...
            <ul className="space-y-3 text-gray-400">
              <li>• Behavioral escalation prediction</li>
              <li>• Victim safety monitoring</li>
              <li>• Digital abuse detection</li>
