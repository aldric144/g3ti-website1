        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-[#12F6C8]/10">
            <div className="flex items-center justify-between">
              <Link href="/dossiers/national-security-briefing.html" className="text-gray-400 hover:text-[#12F6C8] transition-colors">
                ← National Security Briefing
              </Link>
              <Link href="/dossiers/threat-architecture.html" className="text-[#12F6C8] hover:underline">
